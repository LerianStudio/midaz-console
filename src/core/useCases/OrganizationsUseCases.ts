...
class OrganizationsUseCases implements IOrganizationsUseCases {
  ...
  private castOrganizationToEntity(organization: OrganizationsType) {
    ...
    if(organization.organizationAccentColor) metadata = { ...metadata, organizationAccentColor: organization.organizationAccentColor }
    if(organization.organizationAvatar) metadata = { ...metadata, organizationAvatar: organization.organizationAvatar }
    if(organization.metadata) metadata = { ...metadata, ...organization.metadata }
