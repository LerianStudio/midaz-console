...
export default function LedgersView() {
    ...
    const getSheetTitle = (mode: string, ledgerData: LedgerEntity | null, t: any) => {
        if (mode === 'create') {
    ...
    const [currentLedgerForDeletion, setCurrentLedgerForDeletion] = useState<LedgerEntity | undefined>(undefined)
    ...
    const updateLedgerData = async (id: string, values: z.infer<typeof formSchema>) => {
