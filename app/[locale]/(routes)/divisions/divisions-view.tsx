...
import { createDivision, deleteDivision, updateDivision } from '@/client/divisionsClient'
...
export default function DivisionsView({ divisionsData }: DivisionsViewProps) {
    ...
    const getSheetTitle = (mode: string, divisionData: DivisionEntity | null, t: any) => {
        if (mode === 'create') {
    ...
    const updateDivisionData = async (id: string, values: z.infer<typeof formSchema>) => {
